...
exports.createRabbitMqConnection = void 0;
const amqplib_1 = __importDefault(require("amqplib"));
const createRabbitMqConnection = () => __awaiter(void 0, void 0, void 0, function* () {
    /**
     * RABBIT MQ SERVER
     */
    const rabbitMqServer = 'amqp://guest:guest@localhost:5672';
    const connection = yield amqplib_1.default.connect(rabbitMqServer);
